...
def get_colors(elements):
    c = {"red" : 0, "orange": 0, "yellow": 0,"lime": 0,"green": 0,"turquoise": 0,"cyan": 0,"cobalt": 0,"blue": 0,"violet": 0,"magenta": 0,"crimson": 0}
...
image = plt.imread("C:\\Users\\Ilya\\Downloads\\balls_and_rects.png")
binary = image.copy()[:, :, 0]
binary[binary > 0] = 1
...
balls, rects = [], []
print("Amount of all shapes:", np.max(labeled))
